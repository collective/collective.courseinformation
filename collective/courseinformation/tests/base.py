...
def setup_product():
    ...
    import collective.courseinformation
    zcml.load_config('configure.zcml', collective.courseinformation)
    ...
    ztc.installPackage('collective.courseinformation')
...
setup_product()
ptc.setupPloneSite(products=['collective.courseinformation'])
